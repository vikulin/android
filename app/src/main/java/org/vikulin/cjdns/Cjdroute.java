...
import org.vikulin.cjdns.util.InputStreamObservable;
                            ...
                            return Observable.create(new Observable.OnSubscribe<Boolean>() {
                                ...
                                public void call(Subscriber<? super Boolean> subscriber) {
                                    try {
                                                    ...
                                                    public void call(Node.Me me) {
                                                        try {
                                                            Process initProcess = new ProcessBuilder("./cjdroute-init",
                                                                    ...
                                                                    .redirectErrorStream(true)
                                                                    .start();
                                                            final InputStream is = initProcess.getInputStream();
                                                            InputStreamObservable.line(is)
                                                                    .subscribeOn(Schedulers.io())
                                                                    .observeOn(Schedulers.io())
                                                                    .subscribe(
                                                                            new Action1<String>() {
                                                                                ...
                                                                                @Override
                                                                                public void call(Throwable throwable) {
                                                                                    Log.e("Init-"+TAG, "Failed to parse input stream", throwable);
                                                                                    if (is != null) {
                                                                                        try {
                                                                                            is.close();
                                                                                        } catch (IOException e) {
                                                                            ...
                                                                            new Action0() {
                                                                                @Override
                                                                                public void call() {
                                                                                    Log.i("Init-"+TAG, "Completed parsing of input stream");
                                                                                    if (is != null) {
                                                                                        try {
                                                                                            is.close();
                                                                                        } catch (IOException e) {
                                                            ...
                                                            Log.e("Init-"+TAG, "Failed to start cjdroute-init process", e);
                                                        }
                                                    }
                                                }, new Action1<Throwable>() {
                                                    @Override
                                                    public void call(Throwable throwable) {
                                                        Log.e("Init-"+TAG, "Failed to start cjdroute-init process", throwable);
                                                    }
                                                });
                                        ...
                                        //Observable<List<Node.Peer>> peerStats = AdminApi.InterfaceController.peerStats(api);
